...
model_urls = {
    'mobilenet_v3': 'https://github.com/d-li14/mobilenetv3.pytorch/raw/master/pretrained/mobilenetv3-small-55df8e1f.pth',
}
...
class MobileNetV3(nn.Module):
    def __init__(self, mode='small', num_classes=1000, width_mult=1.):
        ...
        self.extras = nn.ModuleList([
            InvertedResidual(576, _make_divisible(576 * 0.2, 8), 512, 3, 2, True, True),   
