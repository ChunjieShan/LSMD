...
if __name__ == '__main__':
    ROOTDIR = '/home/scj/Projects/Code/Data/PSAX-A/PSAX_OD/New/new_data'
    ROOTDIR_LABEL = os.path.join(ROOTDIR, "labels/")
    ROOTDIR_VIDEO = os.path.join(ROOTDIR, 'video_data/')
    ROOTDIR_DATASET = os.path.join(ROOTDIR, "Dataset_ssd_v1/")
    ...
    dataset = Label2COCO(ROOTDIR_VIDEO, ROOTDIR_LABEL, ROOTDIR_DATASET, label_names, 300, True)
