        ...
        while True:
            ...
            if len(tensor_list) == self.frame_len:
                ...
                if len(curr_target_labels):
                    ...
                    # if len(self.memory_buffer) == 0:
                    #     x_lt = x_lt.flatten(2).transpose(1, 2)
                    #     self.memory_buffer = [x_lt for _ in range(5)]
                    else:
...
if __name__ == '__main__':
    ...
    weight_path = "./outputs/1013_6_clips_ltam_ad/best_map_model_88.pth"
    ...
    infer = SSDXMemInference(weight_path, cfg, device="cuda:0", score_th=0.5)
    ...
    if os.path.isdir(video_path):
        for video in os.listdir(video_path):
            ...
            infer(curr_video_path, "./demo_results/exp1")
    else:
        infer(video_path, "./demo_results/exp1")
